...
router.put("/recruiter/one/profile/:recruiterId", authenticateUser, authorizePermission("recruiter"), uploadProfilePicture, profileController.getRecruiterDetails);
